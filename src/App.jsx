...
function App() {
  ...
  return (
    <>
      <div className="bg-black h-screen bg-cover px-6 py-20 md:py-28 md:px-96">
        <div className="text-white bg-slate-900 py-5 px-8 md:px-14 rounded-3xl md:mx-16">
          <img src="/images/icon-star.svg" alt="star" className="my-5 rounded-full px-4 py-4 bg-slate-800" />
          <h2 className="text-4xl font-bold mb-6">How did we do?</h2>
          ...
          <div className="flex justify-center my-5">
            <button onClick={handleSubmit} className="bg-orange-500 hover:bg-white hover:text-orange-500 rounded-3xl px-40 flex  justify-center py-3">SUBMIT</button>
          </div> 
        </div>
      </div>
